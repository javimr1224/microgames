    ...
    <div class="relative min-h-screen flex flex-col items-center justify-center">
        <header
            ...
            <div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center py-6">
                <div class="flex items-center">
                    <img src="<?php echo e(asset('images/image.png')); ?>" alt="Microgames Logo" class="mr-3 h-8 w-8">
                ...
                <div class="flex items-center">
                    <?php if(Route::has('login')): ?>
                        ...
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="ml-8 text-gray-300 hover:text-white">
                            ...
                            <?php if(Route::has('register')): ?>
                                <a href="<?php echo e(route('register')); ?>" class="ml-8 text-gray-300 hover:text-white">
                                ...
                                <a href="<?php echo e(route('login')); ?>" class="ml-8 relative">
                                    <img src="<?php echo e(asset('images/button.png')); ?>" alt="Login button" style="width: 100px;">
        ...
        <div class="w-full">
            <img class="w-full h-auto"
                src="<?php echo e(asset('videos/may-sitting-near-waterfall-pokemon-emerald-pixel-wallpaperwaifu-com-ezgif.com-video-to-gif-converter.gif')); ?>"
...
<?php /**PATH C:\Users\Javier\Documents\microgames\resources\views/welcome.blade.php ENDPATH**/ ?>