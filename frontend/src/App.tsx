        ...
        <Routes>
          ...
          <Route path="/" element={
            ...
            />
                    ...
                    <Route path="/snake" element={<GameRoute component={SnakeGame} user={user} onBack={handleBackToMenu} onScore={(score: number) => handleScore('snake', score)} />} />


                    <Route path="/pong" element={<GameRoute component={PongGame} user={user} onBack={handleBackToMenu} onScore={(score: number) => handleScore('pong', score)} />} />


                    <Route path="/tetris" element={<GameRoute component={TetrisGame} user={user} onBack={handleBackToMenu} onScore={(score: number) => handleScore('tetris', score)} />} />


                    <Route path="/breakout" element={<GameRoute component={BreakoutGame} user={user} onBack={handleBackToMenu} onScore={(score: number) => handleScore('breakout', score)} />} />


                    <Route path="/skybound" element={<GameRoute component={SkyboundGame} user={user} onBack={handleBackToMenu} onScore={(score: number) => handleScore('skybound', score)} />} />
