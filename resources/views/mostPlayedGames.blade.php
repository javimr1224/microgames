...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold mb-4">Most Played Games</h1>
        ...
        @foreach ($games as $game)
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div class="p-4">
                    ...
                    <a href="{{ route('games.show', $game->id) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Play Now</a>
                </div>
            </div>
        @endforeach
    </div>
