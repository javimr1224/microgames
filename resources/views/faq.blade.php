...
<body class="antialiased bg-gray-900 text-white font-sans flex flex-col min-h-screen">
    <div class="flex-grow">
        ...
        <div
            class="relative w-full h-[200px] sm:h-[300px] lg:h-[400px] overflow-hidden flex items-center justify-center">
        ...
        <section class="bg-[#020617] text-white py-8 sm:py-12 lg:py-16 px-4 sm:px-6 lg:px-8">
            <div class="max-w-7xl mx-auto text-left">
                ...
                <p class="mt-2">Sí, necesitas una cuenta para jugar y poder guardar tus puntuaciones.</p>
                <br>
                <h3 class="text-xl" style="font-family: 'Press Start 2P', cursive;">¿Cómo guardo mi puntuación?</h3>
                <p class="mt-2">Inicia sesión en tu cuenta y tu puntuación se guardará automáticamente al final de
                    cada partida.</p>
            </div>
        </section>
