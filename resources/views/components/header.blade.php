<header class="sticky top-0 z-50"
    ...
    <div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center py-6">
        ...
        <div id="main-menu" class="hidden md:flex md:items-center md:w-auto w-full">
            <nav class="flex flex-col md:flex-row md:items-center space-y-4 md:space-y-0 md:space-x-8">
            ...
            <div class="flex items-center mt-4 md:mt-0 md:ml-24">
                ...
                <a href="{{ route('cart') }}" id="header-cart-icon" class="ml-6 cursor-pointer">
                    ...
                    @auth
                        <div class="relative dropdown-container ml-6">
                            ...
                            <div class="absolute mt-2 py-2 w-48 bg-gray-800 rounded-md shadow-xl z-20 dropdown-content right-0">
                                ...
                                <a href="{{ route('my-games') }}"
                                    class="flex items-center px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-server mr-2"><path d="M2 14h20v6a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-6zm0-12a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v6H2V2z"></path><line x1="6" y1="6" x2="6.01" y2="6"></line><line x1="6" y1="18" x2="6.01" y2="18"></line></svg>
                                    Mis juegos
                                </a>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        hamburgerButton.addEventListener('click', function() {
            ...
            mainMenu.classList.toggle('top-20');
            mainMenu.classList.toggle('right-0');
            mainMenu.classList.toggle('bg-slate-900');
            mainMenu.classList.toggle('flex-col');
            mainMenu.classList.toggle('items-center');
            mainMenu.classList.toggle('p-10');
            mainMenu.classList.toggle('space-y-6');
        });
    });
</script>
