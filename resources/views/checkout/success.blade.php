...
<head>
    ...
    <title>Pago Exitoso - Microgames</title>
...
<body class="antialiased bg-gray-900 text-white font-sans flex flex-col min-h-screen">
    <div class="flex-grow">
        ...
        <main class="max-w-7xl mx-auto mt-12 py-12 px-4 text-center">
            <h1 class="text-4xl font-bold mb-4" style="font-family: 'Press Start 2P', cursive; color: #28a745;">¡Pago Completado!</h1>
            <p class="text-lg text-gray-300 mb-8">Gracias por tu compra, tu juego ha sido añadido a la biblioteca</p>
