...
<head>
    ...
    <title>Newest Games - Microgames</title>
        ...
        <main class="py-16 px-4 sm:px-6 lg:px-8">
            <div class="max-w-7xl mx-auto text-center">
                ...
                <p class="mt-6 max-w-3xl mx-auto text-gray-300" style="font-size: 20px;">
                    Aquí tienes los juegos más nuevos de nuestra colección.
                </p>
            </div>
                    ...
                    <div
                        ...
                        <div class="p-6">
                            <div class="relative z-10">
                                <img class="w-full h-40 object-cover mb-4 rounded-lg" src="{{ $game->image_url }}"
                                    alt="{{ $game->name }}">
