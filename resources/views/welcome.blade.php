            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 md:grid-cols-12 gap-8 mb-12">
                    ...
                    <div class="md:col-span-2 space-y-4" style="font-size: 18px; letter-spacing: -0.48px;">
                        ...
                        <div class="space-y-4">
                            <p class="leading-[1.3]"><a href="#" class="hover:text-[#e9c46a] transition-colors">Dark
                                    theme</a></p>
                    ...
                    <div class="md:col-span-3 space-y-6" style="font-size: 18px; letter-spacing: -0.48px;">
                        ...
                        <div class="space-y-6">
                            <p class="leading-[1.3]"><a href="#" class="hover:text-[#e9c46a] transition-colors">Soporte
                                    técnico</a></p>
                            <p class="leading-[1.3]"><a href="#" class="hover:text-[#e9c46a] transition-colors">FAQ /
                                    Guía de inicio</a></p>
                        </div>
                    </div>
                ...
                <div class="flex flex-col md:flex-row justify-between items-center gap-6 pt-8">
                    <p class="opacity-50 text-xxl whitespace-nowrap" style="letter-spacing: -0.48px; line-height: 1.3;">
