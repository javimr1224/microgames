...
<body class="antialiased bg-gray-900 text-white font-sans">
    <div class="relative min-h-screen flex flex-col items-center justify-center">
        <header
            ...
            <div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center py-6">
                ...
                <div class="flex items-center">
                    @if (Route::has('login'))
                        @auth
                            <a href="{{ url('/dashboard') }}" class="text-sm font-semibold text-gray-300 hover:text-white">Dashboard</a>
                        @else
                            <a href="{{ route('login') }}" class="ml-8 text-gray-300 hover:text-white">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Log in">
                                    <title>Log in</title>
                                    <path
        ...
        <div class="relative w-full h-96">
            ...
            <div class="absolute inset-0 flex flex-col items-center justify-center gap-4 animate-float">
        ...
        <footer class="w-full bg-[#020617] text-white py-12 relative overflow-hidden" style="font-family: 'Helvetica Neue', sans-serif;">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 md:grid-cols-12 gap-8 mb-12">
                    ...
                    <div class="md:col-span-5 space-y-6">
                        ...
                        <p class="text-xxl leading-[1.3] opacity-60" style="letter-spacing: -0.48px;">
                            Pequeños juegos, grandes desafíos.<br> Entra en el universo retro de MicroGames y revive la magia del píxel.<br> Juega, compite y desbloquea logros en cada partida.
                        </p>
                    </div>
                    ...
                    <div class="md:col-span-2 space-y-4" style="font-size: 18px; letter-spacing: -0.48px;">
                        ...
                        <div class="space-y-3">
                            <p class="leading-[1.3]"><a href="#" class="hover:text-[#e9c46a] transition-colors">Juegos</a></p>
                            <p class="leading-[1.3]"><a href="#" class="hover:text-[#e9c46a] transition-colors">Ayuda</a></p>
                            <p class="leading-[1.3]"><a href="#" class="hover:text-[#e9c46a] transition-colors">Catálogo</a></p>
                            <p class="leading-[1.3]"><a href="#" class="hover:text-[#e9c46a] transition-colors">Tienda</a></p>
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-2 space-y-4" style="font-size: 18px; letter-spacing: -0.48px;">
                        ...
                        <div class="space-y-4">
                            <p class="leading-[1.3]"><a href="#" class="hover:text-[#e9c46a] transition-colors">Dark theme</a></p>
                    ...
                    <div class="md:col-span-3 space-y-6" style="font-size: 18px; letter-spacing: -0.48px;">
                        ...
                        <div class="space-y-6">
                            <p class="leading-[1.3]"><a href="#" class="hover:text-[#e9c46a] transition-colors">Soporte técnico</a></p>
                            <p class="leading-[1.3]"><a href="#" class="hover:text-[#e9c46a] transition-colors">FAQ / Guía de inicio</a></p>
                        </div>
                    </div>
                ...
                <div class="flex flex-col md:flex-row justify-between items-center gap-6 pt-8">
                    <p class="opacity-50 text-xxl whitespace-nowrap" style="letter-spacing: -0.48px; line-height: 1.3;">© 2025-2026 All Rights Reserved.</p>
                    <div class="flex items-center gap-4 md:gap-[25px]">
                        <a href="#" class="w-10 h-10 hover:opacity-80 transition-opacity">
                            <img alt="Spotify" class="w-full h-full object-cover" src="{{ asset('images/spoti.png') }}" />
                        </a>
                        <a href="#" class="w-10 h-10 hover:opacity-80 transition-opacity">
                            <div class="relative w-full h-full overflow-hidden">
                                <img alt="YouTube" class="absolute h-[170.47%] left-[-2.63%] max-w-none top-[-35.23%] w-[105.26%]" src="{{ asset('images/yt.png') }}" />
                            </div>
                        </a>
                        <a href="#" class="w-10 h-10 hover:opacity-80 transition-opacity">
